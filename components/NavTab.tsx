    ...
    return (
        <nav className="bg-base-200 w-full p-4 flex justify-end items-center shadow-lg">
            <Link href={`/?search=online`} passHref>
                <span
                    className={`p-2 mx-2 bg-base-300 rounded-md transition duration-300 ease-in-out transform hover:bg-base-400 active:bg-base-500 hover:scale-105 ${search === "online" && "bg-green-400"
                        }`}
                >
                    Online
                </span>
            ...
            <Link href={`/?search=all`} passHref>
                <span
                    className={`p-2 mx-2 bg-base-300 rounded-md transition duration-300 ease-in-out transform hover:bg-base-400 active:bg-base-500 hover:scale-105 ${search === "all" && "bg-green-400"
                        }`}
                >
                    All
                </span>
